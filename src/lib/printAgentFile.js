...
// El contenido del agente está embebido como string para evitar
// problemas de importación ?raw en el entorno de build.
...
//
// Uso:  node accreditevent-print-agent.js
...
export function downloadAgentScript() {
  const blob = new Blob([AGENT_SCRIPT], { type: 'application/javascript' });
