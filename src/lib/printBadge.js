// Impresión de credenciales vía diálogo nativo del navegador.
// El navegador muestra la lista de impresoras instaladas y el usuario
// selecciona cuál usar. Funciona igual en cloud (Base44) y self-hosted,
// sin depender de CUPS ni de ningún backend.
